...
export default function Home() {
  ...
  return (
    <div className="container mx-auto max-w-[500px]">
      <div className="flex flex-col h-screen bg-white-900">
        <h1 className="bg-gradient-to-r from-red-500 to-red-500 text-transparent bg-clip-text text-center py-3 font-bold text-6xl">Realtime Chatbot By Aman Gupta</h1>
